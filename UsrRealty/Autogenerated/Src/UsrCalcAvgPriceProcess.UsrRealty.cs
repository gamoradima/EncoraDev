namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAvgPriceProcessMethodsWrapper(Process process)
			: base(process) {
